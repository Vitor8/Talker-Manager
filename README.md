...
Projeto realizado na Trybe. Foi desenvolvido uma API de um CRUD (**C**reate, **R**ead, **U**pdate e **D**elete) de palestrantes. Criei alguns endpoints que irão ler e escrever em um arquivo, utilizando o módulo `fs`.
...
- `git clone git@github.com:Vitor8/Talker-Manager.git`.
...
Para fazer a análise estática do código utilizo o [ESLint](https://eslint.org/).

Este projeto já vem com as dependências relacionadas ao _linter_ configuradas nos arquivos `package.json`.

Para poder rodar o `ESLint` em um projeto basta executar o comando `npm install` dentro do projeto e depois `npm run lint`. 

---

## Lista de requisitos

Abaixo segue os requisitos requeridos pela Trybe.
